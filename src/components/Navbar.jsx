...
export default function Navbar() {
  ...
  return (
    <header className="absolute top-4 left-1/2  -translate-x-1/2 z-50 w-[95%] max-w-[1000px] px-6 py-4 bg-gradient-to-r from-[#37123e]/90 to-[#5F1A63]/90 backdrop-blur-md shadow-2xl rounded-full border border-white/20">
